...
//			
//			String country=table.findElement(By.xpath("//*[@id=\"mw-content-text\"]/div[1]/table/tbody/tr[2]/td[1]")).getText();
//			String population=table.findElement(By.xpath("//*[@id=\"mw-content-text\"]/div[1]/table/tbody/tr[2]/td[3]")).getText();
//			String perOfWorld=table.findElement(By.xpath("tr["+r+"]/td[3]")).getText();
//			String date=table.findElement(By.xpath("//*[@id=\"mw-content-text\"]/div[1]/table/tbody/tr[1]/td[4]")).getText();
//			String source=table.findElement(By.xpath("//*[@id=\"mw-content-text\"]/div[1]/table/tbody/tr[2]/td[6]")).getText();
